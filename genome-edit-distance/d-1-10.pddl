...
;; sequence 2 (names): ((normal sub6) (inverted g36) (normal sub2) (normal sub4) (inverted sub9) (normal g40) (inverted sub12) (normal sub13) (normal sub5) (inverted sub11) (inverted sub15) (inverted sub14) (inverted sub1) (inverted sub10) (normal sub7) (inverted sub8) (normal sub3))

(define (problem trachelium-to-codonopsis)
        ...
        (:goal (and (normal sub6) (inverted g36) (normal sub2)
                    ...
                    (inverted sub12) (normal sub13) (normal sub5)
