...
(define (problem legousia-to-triodanus) (:domain genome-edit-distance)
        ...
        (:init (normal sub6) (normal sub1) (inverted g90) (normal sub3)
               (normal sub4) (normal sub5) (normal sub2) (present sub6)
               (present sub1) (present g90) (present sub3)
               (present sub4) (present sub5) (present sub2)
               (cw sub2 sub6) (cw sub5 sub2) (cw sub4 sub5)
               (cw sub3 sub4) (cw g90 sub3) (cw sub1 g90)
               (cw sub6 sub1) (idle) (= (total-cost) 0))
        (:goal (and (normal sub6) (normal sub5) (normal sub1)
                    (normal sub3) (normal g90) (normal sub4)
                    (normal sub2) (cw sub2 sub6) (cw sub4 sub2)
                    (cw g90 sub4) (cw sub3 g90) (cw sub1 sub3)
                    (cw sub5 sub1) (cw sub6 sub5)))
