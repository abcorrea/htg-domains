...
;; simplified sequence 2: (107 -106 -117 114 40 -108 -116 115 -36 -109 -112 111 113 -118 -110)
...
;; sequence 2 (names): ((normal sub2) (inverted sub1) (inverted sub12) (normal sub9) (normal g40) (inverted sub3) (inverted sub11) (normal sub10) (inverted g36) (inverted sub4) (inverted sub7) (normal sub6) (normal sub8) (inverted sub13) (inverted sub5))

(define (problem tobacco-to-symphyandra) (:domain genome-edit-distance)
        ...
        (:goal (and (normal sub2) (inverted sub1) (inverted sub12)
                    (normal sub9) (normal g40) (inverted sub3)
                    ...
                    (cw sub3 sub11) (cw g40 sub3) (cw sub9 g40)
                    (cw sub12 sub9) (cw sub1 sub12) (cw sub2 sub1)))
