...
(define (problem campanula-to-adenophora)
        ...
        (:objects sub1 - gene sub4 - gene g40 - gene sub3 - gene sub2 -
            gene p4 - pos p3 - pos p2 - pos p1 - pos p0 - pos)
        (:init (normal sub1) (at sub1 p4) (normal sub4) (at sub4 p3)
               (normal sub3) (at sub3 p2) (normal g40) (at g40 p1)
        ...
        (:goal (and (normal sub1) (at sub1 p4) (inverted sub4)
                    (at sub4 p3) (normal g40) (at g40 p2)
                    (inverted sub3) (at sub3 p1) (normal sub2)
                    (at sub2 p0)))
