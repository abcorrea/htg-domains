...
(define (problem adenophora-to-campanula)
        ...
        (:objects sub1 - gene sub4 - gene sub3 - gene g40 - gene sub2 -
            gene p4 - pos p3 - pos p2 - pos p1 - pos p0 - pos)
        (:init (normal sub1) (at sub1 p4) (normal sub4) (at sub4 p3)
               (normal g40) (at g40 p2) (normal sub3) (at sub3 p1)
               (normal sub2) (at sub2 p0)
               (transvert-shift p4 p4 p0 p4 p0)
               (transvert-shift p4 p4 p0 p0 p4)
               (transvert-shift p4 p4 p1 p4 p1)
               (transvert-shift p4 p4 p1 p0 p4)
               (transvert-shift p4 p4 p1 p1 p0)
               (transvert-shift p4 p4 p2 p4 p2)
               (transvert-shift p4 p4 p2 p0 p4)
               (transvert-shift p4 p4 p2 p1 p0)
               (transvert-shift p4 p4 p2 p2 p1)
               (transvert-shift p4 p0 p1 p4 p1)
               (transvert-shift p4 p0 p1 p1 p4)
               (transvert-shift p4 p0 p2 p0 p1)
               (transvert-shift p4 p0 p2 p4 p2)
               (transvert-shift p4 p0 p2 p1 p4)
               (transvert-shift p4 p0 p2 p2 p0)
               (transvert-shift p4 p1 p2 p1 p0)
               (transvert-shift p4 p1 p2 p0 p1)
               ...
               (transvert-shift p2 p2 p0 p0 p4)
               (transvert-shift p2 p3 p4 p2 p4)
               (transvert-shift p2 p3 p4 p4 p2)
               (transvert-shift p2 p3 p0 p3 p4)
               (transvert-shift p2 p3 p0 p2 p0)
               (transvert-shift p2 p3 p0 p4 p2)
               (transvert-shift p2 p3 p0 p0 p3)
               (transvert-shift p2 p4 p0 p4 p3)
               (transvert-shift p2 p4 p0 p3 p4)
               (transvert-shift p2 p4 p0 p2 p0)
               (transvert-shift p2 p4 p0 p0 p2)
               ...
               (invert-shift p4 p2 p0 p1) (invert-shift p4 p2 p1 p0)
               (invert-shift p4 p3 p4 p3) (invert-shift p4 p3 p3 p4)
               (invert-shift p4 p3 p0 p2) (invert-shift p4 p3 p2 p0)
               ...
               (invert-shift p2 p0 p3 p4) (invert-shift p2 p0 p4 p3)
               ...
               (invert-shift p1 p0 p2 p4) (invert-shift p1 p0 p4 p2)
               ...
               (transpose-shift p3 p3 p0 p0 p4)
               (transpose-shift p3 p3 p1 p3 p1)
               (transpose-shift p3 p3 p1 p4 p3)
               (transpose-shift p3 p3 p1 p0 p4)
               (transpose-shift p3 p3 p1 p1 p0)
               (transpose-shift p3 p4 p0 p3 p4)
               (transpose-shift p3 p4 p0 p4 p0)
               (transpose-shift p3 p4 p0 p0 p3)
               (transpose-shift p3 p4 p1 p3 p0)
               (transpose-shift p3 p4 p1 p4 p1)
               (transpose-shift p3 p4 p1 p0 p3)
               (transpose-shift p3 p4 p1 p1 p4)
               (transpose-shift p3 p0 p1 p3 p4)
               (transpose-shift p3 p0 p1 p4 p0)
               ...
               (transpose-shift p2 p2 p0 p0 p4)
               (transpose-shift p2 p3 p4 p2 p3)
               (transpose-shift p2 p3 p4 p3 p4)
               (transpose-shift p2 p3 p4 p4 p2)
               (transpose-shift p2 p3 p0 p2 p4)
               (transpose-shift p2 p3 p0 p3 p0)
               (transpose-shift p2 p3 p0 p4 p2)
               (transpose-shift p2 p3 p0 p0 p3)
               (transpose-shift p2 p4 p0 p2 p3)
               (transpose-shift p2 p4 p0 p3 p4)
               (transpose-shift p2 p4 p0 p4 p0)
               (transpose-shift p2 p4 p0 p0 p2)
               ...
               (transpose-shift p0 p2 p3 p3 p0) (between p4 p3 p3)
               (between p4 p3 p2) (between p4 p3 p1) (between p4 p3 p0)
               (between p4 p3 p4) (between p4 p2 p2) (between p4 p2 p1)
               (between p4 p2 p0) (between p4 p2 p4) (between p4 p1 p1)
               (between p4 p1 p0) (between p4 p1 p4) (between p4 p0 p0)
               (between p4 p0 p4) (between p4 p4 p4) (between p3 p2 p2)
               (between p3 p2 p1) (between p3 p2 p0) (between p3 p2 p4)
               (between p3 p2 p3) (between p3 p1 p1) (between p3 p1 p0)
               (between p3 p1 p4) (between p3 p1 p3) (between p3 p0 p0)
               (between p3 p0 p4) (between p3 p0 p3) (between p3 p4 p4)
               (between p3 p4 p3) (between p3 p3 p3) (between p2 p1 p1)
               (between p2 p1 p0) (between p2 p1 p4) (between p2 p1 p3)
               (between p2 p1 p2) (between p2 p0 p0) (between p2 p0 p4)
               (between p2 p0 p3) (between p2 p0 p2) (between p2 p4 p4)
               (between p2 p4 p3) (between p2 p4 p2) (between p2 p3 p3)
               (between p2 p3 p2) (between p2 p2 p2) (between p1 p0 p0)
               (between p1 p0 p4) (between p1 p0 p3) (between p1 p0 p2)
               (between p1 p0 p1) (between p1 p4 p4) (between p1 p4 p3)
               (between p1 p4 p2) (between p1 p4 p1) (between p1 p3 p3)
               (between p1 p3 p2) (between p1 p3 p1) (between p1 p2 p2)
               (between p1 p2 p1) (between p1 p1 p1) (between p0 p4 p4)
               ...
               (between p0 p1 p0) (between p0 p0 p0) (cw p4 p0)
               (cw p3 p4) (cw p2 p3) (cw p1 p2) (cw p0 p1) (idle)
               (= (total-cost) 0))
        (:goal (and (normal sub1) (at sub1 p4) (inverted sub4)
                    (at sub4 p3) (inverted sub3) (at sub3 p2)
                    (normal g40) (at g40 p1) (normal sub2)
                    (at sub2 p0)))
