...
(define (problem triodanus-to-asyneuma) (:domain genome-edit-distance)
        (:objects sub3 - gene sub1 - gene sub4 - gene sub5 - gene g56 -
            gene sub2 - gene p5 - pos p4 - pos p3 - pos p2 - pos p1 -
            pos p0 - pos)
        (:init (normal sub3) (at sub3 p5) (normal sub5) (at sub5 p4)
               (normal sub1) (at sub1 p3) (inverted g56) (at g56 p2)
               ...
               (idle) (= (total-cost) 0))
        (:goal (and (normal sub3) (at sub3 p5) (normal sub1)
                    (at sub1 p4) (normal sub4) (at sub4 p3)
                    (normal sub5) (at sub5 p2) (inverted g56)
                    (at g56 p1) (normal sub2) (at sub2 p0)))
