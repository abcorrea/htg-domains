...
(define (problem symphyandra-to-campanula)
        ...
        (:objects sub1 - gene sub4 - gene sub3 - gene sub2 - gene p3 -
            pos p2 - pos p1 - pos p0 - pos)
        (:init (normal sub1) (at sub1 p3) (normal sub3) (at sub3 p2)
               ...
               (= (total-cost) 0))
        (:goal (and (normal sub1) (at sub1 p3) (normal sub4)
                    (at sub4 p2) (inverted sub3) (at sub3 p1)
