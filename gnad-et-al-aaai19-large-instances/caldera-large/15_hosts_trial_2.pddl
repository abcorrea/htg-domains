...
; This has 15 hosts, 2 user, 2 admin per host, 2 active account per host
(define (problem p15_hosts_trial_2)
(:domain caldera)
(:objects str__ce str__cu str__cs str__dg str__e str__br str__alpha str__ct str__cn str__di str__du str__b str__bq str__bx str__ei str__james str__cm str__w str__bj str__dv str__dh str__bd str__by str__f str__be str__dn str__em str__j str__cz str__o str__cg str__bz str__ej str__x str__cl str__do str__cf str__bk str__v str__q str__p str__da str__ed str__bs str__i str__dw str__db str__ec str__eb str__bc str__mary str__dp str__ek str__bl - string 
 id_bmHost id_btHost id_dqHost id_eeHost id_coHost id_yHost id_chHost id_cvHost id_kHost id_dcHost id_dxHost id_bfHost id_caHost id_djHost id_rHost - ObservedHost 
 id_gDomainUser id_cDomainUser - ObservedDomainUser 
 id_dDomainCredential id_hDomainCredential - ObservedDomainCredential 
 id_fcRat id_fmRat id_fgRat id_feRat id_foRat id_ffRat id_fdRat id_fhRat id_flRat id_fkRat id_fqRat id_elRat id_fjRat id_fiRat id_fnRat id_fpRat - ObservedRat 
 id_esSchtask id_epSchtask id_eoSchtask id_exSchtask id_erSchtask id_etSchtask id_euSchtask id_fbSchtask id_evSchtask id_ewSchtask id_eqSchtask id_eySchtask id_ezSchtask id_faSchtask id_enSchtask - ObservedSchtask 
 id_gmFile id_giFile id_glFile id_gkFile id_grFile id_gtFile id_guFile id_gjFile id_gnFile id_gqFile id_gsFile id_ghFile id_ggFile id_gpFile id_goFile - ObservedFile 
 num__13 num__76 num__89 num__48 num__41 num__34 num__62 num__103 num__97 num__26 num__20 num__82 num__104 num__69 num__110 num__33 num__75 num__12 num__96 num__19 num__68 num__61 num__47 num__90 num__55 num__111 num__40 num__27 num__83 num__54 - num 
 id_frShare id_gbShare id_fuShare id_fyShare id_geShare id_fzShare id_gfShare id_fsShare id_gdShare id_gcShare id_ftShare id_fxShare id_fvShare id_gaShare id_fwShare - ObservedShare 
 id_aDomain - ObservedDomain 
 id_cwTimeDelta id_cbTimeDelta id_buTimeDelta id_sTimeDelta id_zTimeDelta id_lTimeDelta id_cpTimeDelta id_drTimeDelta id_bnTimeDelta id_ciTimeDelta id_efTimeDelta id_dkTimeDelta id_bgTimeDelta id_dyTimeDelta id_ddTimeDelta - ObservedTimeDelta 
)
...
(:goal   (and 
     (prop_host id_fpRat id_rHost)
     (prop_host id_fcRat id_bmHost)
     (prop_host id_foRat id_btHost)
     (prop_host id_ffRat id_dqHost)
     (prop_host id_fhRat id_eeHost)
     (prop_host id_fkRat id_coHost)
     (prop_host id_fqRat id_yHost)
     (prop_host id_fjRat id_chHost)
     (prop_host id_fiRat id_cvHost)
     (prop_host id_fmRat id_kHost)
     (prop_host id_fgRat id_dcHost)
     (prop_host id_feRat id_dxHost)
     (prop_host id_fdRat id_caHost)
     (prop_host id_flRat id_djHost)
)
)
)