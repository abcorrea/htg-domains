...
;; simplified sequence 1: (111 114 106 117 118 116 40 107 110 -36 109 120 112 113 115 119 108)
;; simplified sequence 2: (111 -36 107 109 -114 40 -117 -118 110 116 -120 -119 -106 -115 112 -113 108)
;; common subsequences: (((-76 -75 -74 -73 -72 -71 -70 -69 -68 -67 -66 -65 -64 -63 -62 -61) . 106) ((-35 -34 -33 -32 -31 -30 -29 -28 -27 -26) . 107) ((-105 -104 -103 -102 -101 -100 -99 -98 -97) . 108) ((-25 -24 -23 -22 -21 -20 -19 -18) . 109) ((-44 -43 -42 -41 45 46 47 48) . 110) ((1 2 3 4 5 6 7 8) . 111) ((-90 -89 -88 -87 -86 -85 -84) . 112) ((77 78 79 80 81 82 83) . 113) ((9 10 11 12 13 14 15) . 114) ((91 92 93 94 95 96) . 115) ((49 50 51 52 53) . 116) ((-60 -59 -58 -57 -56) . 117) ((-39 -38 -37) . 118) ((-55 -54) . 119) ((-17 -16) . 120))
;; #safe insertions/deletions: 0
;; sequence 1 (names): ((normal sub6) (normal sub9) (normal sub1) (normal sub12) (normal sub13) (normal sub11) (normal g40) (normal sub2) (normal sub5) (inverted g36) (normal sub4) (normal sub15) (normal sub7) (normal sub8) (normal sub10) (normal sub14) (normal sub3))
;; sequence 2 (names): ((normal sub6) (inverted g36) (normal sub2) (normal sub4) (inverted sub9) (normal g40) (inverted sub12) (inverted sub13) (normal sub5) (normal sub11) (inverted sub15) (inverted sub14) (inverted sub1) (inverted sub10) (normal sub7) (inverted sub8) (normal sub3))

(define (problem symphyandra-to-codonopsis)
        ...
        (:init (normal sub6) (normal sub9) (normal sub1) (normal sub12)
               (normal sub13) (normal sub11) (normal g40) (normal sub2)
        ...
        (:goal (and (normal sub6) (inverted g36) (normal sub2)
                    ...
                    (normal sub11) (inverted sub15) (inverted sub14)
